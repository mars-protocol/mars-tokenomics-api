...
async function manualIndex() {
  ...
  try {
    ...
    console.log(`  - Total Supply: ${currentData.total_supply} MARS`);
    console.log(`  - Circulating Supply: ${currentData.circulating_supply} MARS`);
    ...
    console.log(`  - On-Chain Liquidity: $${currentData.on_chain_liquidity_usd.toLocaleString()}`);
    console.log(`  - Total Supply USD: $${currentData.total_supply_usd.toLocaleString()}`);
